...
public class Arguments
{
    ...
    public Dictionary<string, Collection<string>> ParsedArguments => _parameters;
    ...
    {
        List<KeyValuePair<string, string>> m_array = new List<KeyValuePair<string, string>>();

        foreach (var args in _parameters)
        {
            m_array.Add(new KeyValuePair<string, string>(args.Key, args.Value.ToString()));
        }
